    ...
    public partial class InitDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseXStudents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseXStudents_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseXStudents_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseXStudents_CourseId",
                table: "CourseXStudents",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseXStudents_StudentId",
                table: "CourseXStudents",
                column: "StudentId");
